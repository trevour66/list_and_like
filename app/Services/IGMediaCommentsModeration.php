...
class IGMediaCommentsModeration
{
    ...
    public function replyOtherComment($message, $comment_replyingTo)
    {
        ...
        $url = $this->IG_URL . "/" . $comment_replyingTo . "/replies?";
    ...
    private function updateDatabase($message, $commentIG_Id, $fromUsername, $parent_comment)
    {
        logger(print_r("called: updateDatabase", true));
